...
import nl.novi.autogarage.dto.UserRequestDto;
import nl.novi.autogarage.exception.BadRequestException;
import nl.novi.autogarage.exception.InvalidPasswordException;
import nl.novi.autogarage.exception.NotAuthorizedException;
import nl.novi.autogarage.exception.UserNotFoundException;
import nl.novi.autogarage.model.Authority;
...
public class UserService {
    ...
    public String createUser(UserRequestDto userRequestDto) {
        try {
            ...
            for (String s : userRequestDto.getAuthorities()) {
